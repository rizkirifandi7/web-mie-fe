	...
	const handleDelete = async () => {
		...
		try {
			const response = await axios.delete(
				`${process.env.NEXT_PUBLIC_BASE_URL}/media-sosial/${selectedId}`
			);
			...
			console.error("Error deleting media Sosial:", error);
